...
**See also:** [Domain 6 (Demand)](6-demand-conversational-pipeline.md) for routing/SLA enforcement once signals fire, [Domain 0 (AgentOps)](0-agentops.md) for the observability layer the signal feed inherits, [Domain 2 (Strategy)](2-strategy-positioning.md) for sales-call mining → positioning research, [Domain 5 (AEO/GEO)](5-ai-search-answer-visibility.md) for the new "LLM-visibility intent" frontier (track which models cite you when buyers research your category).
